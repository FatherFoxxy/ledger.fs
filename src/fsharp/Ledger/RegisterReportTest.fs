        ...
        let input = [Transaction {date = "2013-01-01";
                     ...
                     Transaction {date = "2013-01-10";
                                  ...
                                  postings = [{account = (InputName(Entity "TEST_ENTITY", "Expenses:Motor:Fuel"));
                                               amount = AUD 5801;}; {account = (InputName(Entity "TEST_ENTITY", "Liabilities:Bankwest:Visa"));
                                               amount = AUD 5801;}];
                                  id=3};
                     BlankLine;
                     ...
                     BalanceVerfication {date = "2013-02-01";
                                         account = (InputName(Entity "TEST_ENTITY", "Assets:Bankwest:Cheque"));
                                         amount = AUD 62105;}]
        let expected = {Report.account = (InputName(Entity "TEST_ENTITY", "Expenses"));
                        from = None;
                        until = None;
                        lines = [{date = "2013-01-05";
                                  amount = AUD 9853;
                                  description = "I bought some groceries and paid using the cheque account.";
                                  account = (InputName(Entity "TEST_ENTITY", "Expenses:Food:Groceries"));
                                  balance = AUD 9853;};
                                 {date = "2013-01-10";
                                  amount = AUD 5801;
                                  description = "I bought some petrol, and paid using a credit card.";
                                  account = (InputName(Entity "TEST_ENTITY", "Expenses:Motor:Fuel"));
                                  balance = AUD 15654;};
                                 {date = "2013-01-15";
                                  amount = AUD 28042;
                                  description = "I paid my electricity bill.";
                                  account = (InputName(Entity "TEST_ENTITY", "Expenses:Electricity"));
                                  balance = AUD 43696;}];}
        (generateReport input (InputName(Entity "TEST_ENTITY", "Expenses"))) |> should equal expected
